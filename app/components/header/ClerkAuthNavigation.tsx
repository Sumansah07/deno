  ...
  if (!isSignedIn || !user) {
    ...
    return (
      <nav className={`flex items-center space-x-4 ${className}`}>
        ...
        >
          <button className="inline-flex items-center justify-center px-4 sm:px-8 py-2 text-sm sm:text-base font-medium text-white bg-black hover:bg-gray-700 border border-gray-800 rounded-lg transition-colors whitespace-nowrap">
            Sign In
          </button>
        </SignInButton>
        <SignUpButton 
