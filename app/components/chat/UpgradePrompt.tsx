          ...
          <div className="flex-1">
            ...
            <div className="flex gap-3">
              ...
              {onDismiss && (
                <button
                  onClick={onDismiss}
                  className="bg-bolt-elements-background-depth-3 hover:bg-bolt-elements-background-depth-1 text-bolt-elements-textPrimary border border-bolt-elements-borderColor px-6 py-3 rounded-lg font-medium transition-colors"
                >
                  Dismiss
                </button>
              )}
