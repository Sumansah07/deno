...
const BEST_MODELS = [
  ...
  { value: 'moonshotai/kimi-k2-thinking', label: 'kimi-k2-thinking', provider: 'OpenRouter', icon: 'i-ph:robot' },
  ...
  { value: 'google/gemini-2.5-flash', label: 'Gemini 2.5 Flash', provider: 'OpenRouter', icon: 'i-ph:google-logo' },
  { value: 'google/gemini-2.5-pro', label: 'gemini-2.5-pro', provider: 'OpenRouter', icon: 'i-ph:google-logo' },
  
  // OpenAI (via OpenRouter)
  { value: 'x-ai/grok-4-fast', label: 'Grok 4 Fast', provider: 'OpenRouter', icon: 'i-ph:brain' },
