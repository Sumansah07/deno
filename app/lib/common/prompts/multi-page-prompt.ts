...
2. **Embedded Everything**:
   ...
   - **ALWAYS use real images from Unsplash/Pexels with valid URLs**
   - **NEVER leave image placeholders empty or use placeholder text**
   - **ALWAYS include actual <img> tags with src="https://images.unsplash.com/..." or src="https://images.pexels.com/..."**
   - Use inline SVGs for custom icons only
   - **ALWAYS use images that are contextually relevant to the app. For example, food delivery apps must use images of food, dishes, restaurants, or delivery scenarios—do not use irrelevant images (e.g., random landscapes or abstract art).
