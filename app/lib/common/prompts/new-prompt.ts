...
When exporting to Figma, designs should be perfect mobile mockups ready for mobile app development.
...
<design_instructions>
  ...
  - Design for 375px width FIRST, then scale up (max-width: 428px for mobile containers)
  - Mobile breakpoints: 320px-428px (mobile), 768px-1024px (tablet), 1024px+ (desktop)
  - Mobile fonts: Minimum 16px body text (prevents iOS zoom), 24px+ headings, use rem/em units
  - Mobile layout: Stack vertically, use flexbox/grid, avoid fixed px widths, 100% width containers
  - Mobile touch: Minimum 44px tap targets, generous spacing (16px+) between interactive elements
  - Mobile images: max-width: 100%, height: auto, responsive, use Pexels URLs only
